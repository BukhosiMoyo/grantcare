      ...
      <div className="shell">
        <div className="footer-grid">
          <div className="footer-brand">
            ...
            <p>{copy.officialNotice}</p>
          </div>
          <div className="space-y-2">
            <p className="footer-heading">{copy.explore}</p>
          ...
          <div className="space-y-2">
            ...
            <div className="mt-3 pt-3 border-t border-border/50">
              <WhatsAppChannelLink locale={locale} className="inline-flex items-center gap-2 text-sm text-white hover:underline" />
            </div>
          </div>
        </div>
