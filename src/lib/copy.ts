...
const ENGLISH_COPY: HomeCopy = {
  ...
  homeStepOne: "Pick a tool.",
  homeStepTwo: "Read the short result.",
  homeStepThree: "Use the official link for the official action.",
  ...
  moreMonthsText: "Open the payment archive for this month.",
  moreMonthsTitle: "More months",
  morePaymentDatesText: "Open this month’s payment categories.",
