...
export const SEO_BATCH_SIX_GUIDES = [
  ...
  },
  {
    ...
    sections: [
      ...
      section(
        "What you can do next",
        "1. Open the relevant official status route for the support record you want to check.\n2. Confirm that the page is official before entering details.\n3. Read the exact wording of the result instead of guessing from memory.\n4. Compare the wording with a plain-language guide if needed.\n5. Follow the official next step only if the system clearly asks you to act.",
      ),
      section(
  ...
  },
  {
    ...
    sections: [
      ...
      section(
        "What you can do next",
        "1. Use the official portal for the actual SRD status check.\n2. Check the address carefully before entering any information.\n3. Read the exact result wording shown there.\n4. Keep a screenshot or note if you want a record.\n5. Use a plain-language guide if you are unsure what the official wording means.",
      ),
      section(
