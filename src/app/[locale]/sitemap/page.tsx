...
export default async function HtmlSitemapPage({
  ...
  const routeCopy = getLocalizedRouteCopy(
    locale,
    {
      ...
      sassaAppeal: "SASSA appeal letter",
    ...
    },
    {
      ...
      sassaAppeal: "Incwadi yesikhalazo se-SASSA",
      interviewGuide: "Umhlahlandlela wenhlolokhono",
      emailTemplate: "Ithempulethi ye-imeyili",
  ...
  const mainPages = [
    ...
    { href: buildLocalePath(locale, "/tools/sassa-appeal"), label: routeCopy.sassaAppeal },
    { href: buildLocalePath(locale, "/tools/interview-guide"), label: routeCopy.interviewGuide },
    { href: buildLocalePath(locale, "/tools/email-template"), label: routeCopy.emailTemplate },
